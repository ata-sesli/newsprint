...
public enum PresetSourceCatalog {
    public static let all: [PresetSource] = [
        preset("ACM Queue", "https://queue.acm.org/rss/feeds/queue_articles.xml", "General CS & Research Journalism", .blog),
        ...
        preset("BAIR Blog", "http://bair.berkeley.edu/blog/feed.xml", "AI Research & Digests", .blog),
        preset("Beej’s Bit Bucket", "https://beej.us/blog/feed/", "Low-Level & Systems Engineering", .blog),
        ...
        preset("Computer, Enhance!", "https://computer-enhance.com/feed/", "Low-Level & Systems Engineering", .blog),
        ...
        preset("Google Project Zero", "https://googleprojectzero.blogspot.com/feeds/posts/default", "Security Research", .blog),
        preset("Google Research Blog", "https://googleresearch.blogspot.com/atom.xml", "AI Research & Digests", .blog),
        ...
        preset("LLVM Project Blog", "https://blog.llvm.org/feeds/posts/default", "Programming Languages & Compilers", .blog),
        preset("Martin Kleppmann", "https://feeds.feedburner.com/martinkl?format=xml", "Technical Essays & Engineering Judgment", .blog),
        preset("NCC Group Research", "https://research.nccgroup.com/feed/", "Security Research", .blog),
        preset("Netflix TechBlog", "https://netflixtechblog.com/feed", "Production Infrastructure, Databases & Builder Signal", .blog),
        ...
        preset("Stripe Engineering", "https://stripe.com/blog/engineering/feed.rss", "Production Infrastructure, Databases & Builder Signal", .blog),
